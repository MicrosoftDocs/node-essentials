...
exports.connectToCosmosWithKey = connectToCosmosWithKey;
...
function connectToCosmosWithKey() {
...
function connectToContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { container } = yield database.containers.createIfNotExists({ id: containerName });
        return container;
    });
}
